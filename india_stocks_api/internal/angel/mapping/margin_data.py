...
from india_stocks_api.internal.context import get_logger, get_token
...
def map_order_type(pricetype):
    ...
    """
    order_type_mapping = {"MARKET": "MARKET", "LIMIT": "LIMIT", "SL": "STOPLOSS_LIMIT", "SL-M": "STOPLOSS_MARKET"}
...
def parse_margin_response(response_data):
    ...
    try:
        ...
        if response_data.get("status") is False:
            return {"status": "error", "message": response_data.get("message", "Failed to calculate margin")}
