...
from algotrade.internal.database.broker_instruments_db import get_broker_symbol

def transform_data(data,token):
    """
    Transforms the new API request structure to the current expected structure.
    """
    symbol = get_broker_symbol(standardized_symbol=data["symbol"], exchange_code=data["exchange"], broker_name="angelone")
    # Basic mapping
    transformed = {
        "apikey": data["apikey"],
